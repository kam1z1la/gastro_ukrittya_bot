package com.gastro_ukrittya.bot.handler.reservation.state.edit_reservation.name;
...
@Slf4j
public class NameEditState implements EditState {
    ...
    public void nextState(EditContext context) {
        context.setState(new NameEditStateUpdater());
    }
}
